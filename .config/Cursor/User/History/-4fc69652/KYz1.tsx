  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        className={
          "h-8 font-normal placeholder:text-neutral-500 w-48 hover:bg-neutral-700 transition-colors shadow-sm focus:hover:bg-neutral-900 rounded-md bg-neutral-900 outline-none px-4 py-[18px] " +
          props.className
        }
        {...props.register}
