  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        className={
          cn(
          "h-8 font-normal placeholder:text-neutral-500 hover:bg-neutral-700 transition-colors shadow-sm focus:hover:bg-neutral-900 rounded-md bg-neutral-900 outline-none px-4 py-[18px]", 
         "w-48",
          props.className)
        }
        {...props.register}
