...
const twMerge = extendTailwindMerge({
  ...
  extend: {
    ...
    conflictingClassGroups: {
      ...
      animate: ["animate"],
      // Add more conflicting class groups as needed
    },
    // Configure which class groups should not be merged but replaced
    conflictingClassGroupModifiers: {
      // Define which modifiers should conflict with each other
      // For example, different responsive variants should replace each other
      responsive: ["responsive"],
      // Add more conflicting modifiers as needed
    },
  },
});
