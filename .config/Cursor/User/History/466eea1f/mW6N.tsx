...
function RouteComponent() {
  ...
  switch (status) {
    case true:
      return <Success boundingId={res?.data} />;
    case false:
      return <Error />;
    default:
      return <Loading />;
...
function Success({ boundingId }: { boundingId: number }) {
  ...
  return (
    <main className="text-center grid place-items-center">
      ...
      <span className="text-xl font-medium">Numero de Vinculacion: {boundingId}</span>
      <span className="text-neutral-500">Ya puedes cerrar esta ventana</span>
