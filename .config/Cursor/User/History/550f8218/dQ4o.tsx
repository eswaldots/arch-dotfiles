...
export const Route = createFileRoute(
  ...
  loaderDeps: ({ params }) => ({ repeinId: params.repeinId }),
  loader: async ({ loaderDeps }) => {
    console.log(loaderDeps)
    const boundingBands = await getRepeinRecordsById(loaderDeps.repeinId)
