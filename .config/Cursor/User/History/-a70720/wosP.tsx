    ...
    <form id="file-form" className="flex flex-col gap-5">
      ...
      <section className="flex flex-col gap-5 w-full">
        ...
        <AgeInput
          ...
          defaultValue={control._defaultValues?.personal_passport_expiration}
          defaultValueAge={control._defaultValues?.personal_passport_years_valid}
        />
      </section>
      ...
      <section className="flex flex-col gap-5 justify-between w-full">
        ...
        <AgeInput
          ...
          defaultValue={control._defaultValues?.personal_birthday}
          defaultValueAge={control._defaultValues?.personal_age}
