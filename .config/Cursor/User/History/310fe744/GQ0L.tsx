...
function RouteComponent() {
  ...
  const handleClick = (repeinId: number) => {
    createWindow({
      url: "/analysis/management/query/" + String(repeinId),
      title: "Ficha de " + String(repeinId),
      label: "/analysis/management/query/repeinId",
      width: 1000,
      height: 600,
      x: 0,
      y: 0,
      ...
      <ItemsTable>
        {members?.map((member, index) => (
          <ItemTable
            ...
            onClick={() => handleClick(member.repein_id)}
            >
