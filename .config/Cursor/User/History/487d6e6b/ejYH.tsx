...
<section className="flex flex-col gap-12">
  ...
  <div className="flex gap-12 items-start">
    ...
    <div className="flex flex-col gap-1 pt-1 rounded-md w-full">
      <div className="flex items-center gap-2">
        ...
        <span className="text-neutral-500">{band?.Codigo || "No disponible"}</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-semibold">Fecha de registro:</span>
        <span className="text-neutral-500">{band?.FechaRegistro || "No disponible"}</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-semibold">Estado:</span>
        <span className="text-neutral-500">{band?.Estado || "No especificado"}</span>
      </div>
      <div className="flex items-center gap-2">
  ...
  <div className="flex gap-12 items-start">
    ...
    <div className="flex flex-col gap-1 pt-1 rounded-md w-full">
      <div className="flex items-center gap-2">
        <span className="font-semibold">Código:</span>
        <span className="text-neutral-500">{member?.repein_code || "No disponible"}</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-semibold">Fecha de registro:</span>
        <span className="text-neutral-500">{member?.repein_registration_date || "No disponible"}</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-semibold">Estado:</span>
        <span className="text-neutral-500">{member?.repein_status || "No especificado"}</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-semibold">Nivel de peligrosidad:</span>
        <span className="text-neutral-500">{member?.repein_danger_level || "No especificado"}</span>
      </div>
    </div>
  </div>
</section>
