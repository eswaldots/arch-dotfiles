...
<section className="flex flex-col gap-12">
  <div className="flex gap-12 items-start">
    ...
    <div className="flex flex-col gap-1 pt-2 rounded-md w-full">
  ...
  <div className="flex gap-16 items-start">
    ...
    <div className="flex flex-col gap-1 rounded-md pt-2 w-full">
      <div className="flex items-center gap-2">
        <span className="font-semibold">Nombre:</span>
        <span className="text-neutral-500">{band?.band_name || "No disponible"}</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-semibold">Código:</span>
        <span className="text-neutral-500">{band?.band_code || "No disponible"}</span>
      </div>
      <div className="flex items-center gap-2">
