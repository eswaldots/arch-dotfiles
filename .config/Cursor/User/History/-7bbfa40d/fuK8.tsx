    ...
    <section className="text-left w-screen px-8 flex flex-col gap-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        <div className="space-y-2">
          ...
          <Select {...register('tipo')} control={control}>
        ...
        <div className="space-y-2">
          ...
          <Select control={control} {...register('tieneProcedimiento')}>
      ...
      <button
        onClick={() => navigate({ to: '/analysis/management/bounding/bounding-person', viewTransition: true, resetScroll: true })}
