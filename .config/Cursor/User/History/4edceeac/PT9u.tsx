...
export default function TextArea(props: InputProps) {
  return (
    <div className="flex flex-col gap-2">
      ...
      <textarea
        className={cn(
          'disabled:hover:bg-neutral-900 font-normal h-8 w-full hover:bg-neutral-700 transition-colors shadow-sm focus:hover:bg-neutral-900 rounded-md bg-black outline-none px-4 py-[18px] ',
          props.className
        )}
        {...props.register}
        {...props}
