...
export default function TextArea(props: InputProps) {
  return (
    <div className="flex flex-col gap-2">
      ...
      <textarea
        className={cn(
          'font-normal h-32 w-full transition-colors shadow-sm rounded-md outline-none px-4 py-[18px]',
          'bg-neutral-900 text-neutral-500 disabled:hover:bg-neutral-900 hover:bg-neutral-700 focus:hover:bg-neutral-900',
          props.className
        )}
        {...props.register}
        {...props}
