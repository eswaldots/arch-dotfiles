...
export default function TextArea(props: InputProps) {
  return (
    <div className="flex flex-col gap-2">
      ...
      <textarea
        className={cn(
          'disabled:hover:bg-neutral-900 font-normal h-8 w-full hover:bg-neutral-700 transition-colors shadow-sm focus:hover:bg-neutral-900 rounded-md outline-none px-4 py-[18px]',
          'bg-neutral-900 text-neutral-500 disabled:hover:bg-neutral-900 ',
          props.className
        )}
        {...props.register}
        {...props}
