    ...
    <section className="text-left w-screen px-8 flex flex-col gap-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
        <div className="space-y-2">
          ...
          <Select errors={errors} control={control} name="bounding_type" label="">
        ...
        <Input errors={errors} register={register("document_id", {required: INPUT_STRING_ERROR_MESSAGE })} label="N° Documento" />
        ...
        <DatePicker errors={errors} register={register('date', { required: INPUT_DATE_ERROR_MESSAGE })} name="date" label="Fecha" />
