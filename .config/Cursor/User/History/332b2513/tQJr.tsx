...
import { INPUT_SELECT_ERROR_MESSAGE } from '@/constants/validations'
    ...
    <section className="text-left w-screen px-8 flex flex-col gap-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
        ...
        <div className="space-y-2 flex flex-col gap-2">
          ...
          <Select control={control} name="organization_id" rules={{ required: INPUT_SELECT_ERROR_MESSAGE }} label="Nombre del Organismo">
            {organismos.map((org) => (
