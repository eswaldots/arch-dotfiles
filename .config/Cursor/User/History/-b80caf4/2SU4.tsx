      ...
      return (
        <div ref={ref} className="relative flex flex-col gap-2">
          ...
          <section className="relative w-full inline-block">
            ...
            <article style={{ opacity: isOpen ? 1 : 0, display: isOpen ? 'block' : 'none' }} className="animate-openSelect transition-all absolute bg-neutral-800 z-50 w-full mt-2 flex flex-col px-4 py-2 rounded-md shadow-sm motion-scale-y-in-75 motion-scale-x-in-75 motion-duration-75 motion-ease motion-preset-fade-lg ">
              {props.children}
            </article>
          </section >
        </div >
