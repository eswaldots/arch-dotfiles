    ...
    <form onSubmit={submitHandler} className="flex h-full flex-col p-6 pb-10">
      <div className="flex flex-col gap-6 p-1 mb-10">
        ...
        <Alert severity="warning" label="Importante">
          Cada módulo requiere una base de datos distinta. Asegúrate de configurar correctamente los parámetros de conexión para este módulo específico. Los cambios realizados aquí solo afectarán al módulo actual y no a los demás. Si necesitas configurar múltiples módulos, deberás hacerlo individualmente para cada uno.
        </Alert>
