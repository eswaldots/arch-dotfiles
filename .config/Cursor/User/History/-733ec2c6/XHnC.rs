use crate::{definitions::{app_definitions::{AppState, Module}, database_definitions::Database, responses_model::{CommandResponse, GenericPost, StatusResponse}}, services};
use tauri::Manager;
