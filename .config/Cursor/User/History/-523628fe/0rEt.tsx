...
export default function RecordForm() {
  ...
  return (
    ...
    >
      <h1 className="text-xl font-bold">Curso o amonestacion</h1>
      <section className="flex flex-col gap-5 justify-between w-full">
        <Input register={register("record_name", { required: INPUT_STRING_ERROR_MESSAGE })} name={"record_name"} label="Nombre del curso o amonestacion" errors={errors} />

        <Select errors={errors} rules={{ required: INPUT_STRING_ERROR_MESSAGE }} control={control} name="record_type" label="Tipo">
          <SelectItem value="admonition">Amonestacion</SelectItem>
