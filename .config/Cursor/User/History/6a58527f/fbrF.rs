...
use crate::{
    definitions::{
        ...
        personal_definitions::{PersonalJSON, PersonalSQL, PublicPersonal}, responses_model::{to_status_response, StatusResponse}
    },
    services,
};
...
pub async fn create_personal(
    ...
    to_status_response(result.map_err(|e| AppError::Database(e)))
}
