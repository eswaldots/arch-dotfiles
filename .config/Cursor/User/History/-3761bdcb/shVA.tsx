...
export const Route = createFileRoute("/_app")({
  ...
  pendingComponent: () =>  <main className="flex items-center justify-center h-screen w-screen"><LoaderIcon /></main>
});
...
function RouteComponent() {
  ...
  useEffect(() => {
    const moduleName = actualRoute.pathname.replace("/", "");
    changeDatabasePool(moduleName as Module);
