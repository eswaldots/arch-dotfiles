              ...
              {routes.map((route, index) => (
                <Link
                  ...
                  className={
                    ...
                    (route.path === actualRoute.pathname ? "text-white hover:opacity-80" : "")
                  }
                >
                  {route.path === actualRoute.pathname && <span className="absolute top-0 left-0 w-full h-full bg-primary rounded-md opacity-30"></span>}
