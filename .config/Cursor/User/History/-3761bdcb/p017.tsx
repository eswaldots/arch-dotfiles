...
export const Route = createFileRoute("/_app")({
  ...
  pendingComponent: () => <main className="flex items-center justify-center h-screen w-screen">loadin</main>,
});
            ...
            <DropdownMenu>
              {routes.map((route, index) => (
                <Link
                  ...
                  to={route.path}
                  className={
                    "flex items-center border-transparent z-20 border px-2 py-2 rounded-md transition gap-2 hover:bg-neutral-900 hover:border-neutral-800 " + 
