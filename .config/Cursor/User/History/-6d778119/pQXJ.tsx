...
function RouteComponent() {
  ...
  // If res is null, status is null. Otherwise, convert res.success to boolean
  const status = res === null ? null : Boolean(res.success);
  ...
  switch (status) {
    ...
    case false:
      ...
      <span className="text-neutral-500">(debug) {JSON.stringify(res?.error)}</span>
