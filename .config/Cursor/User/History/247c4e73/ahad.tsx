  ...
  return (
    ...
    >
      ...
      <Link
        ...
        viewTransition={true}
        className={
          "disabled:text-neutral-950 absolute bg-transparent bottom-6 left-6 transition-colors group active:opacity-30 cursor-default rounded-md bg-neutral-800 text-neutral-100 font-bold " +
