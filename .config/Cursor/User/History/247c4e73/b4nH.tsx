  ...
  return (
    ...
    >
      ...
      <Link
        ...
        viewTransition={true}
        className={
          "disabled:text-neutral-950 absolute bottom-6 left-6 transition-colors group active:opacity-30 cursor-default rounded-md bg-transparent text-neutral-100 font-bold " +
