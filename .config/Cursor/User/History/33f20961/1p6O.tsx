    ...
    <div className='flex flex-col gap-4'>
      <div className='flex flex-col gap-2'> 
        ...
        <div className='flex flex-col gap-2'>
          ...
          <span className='text-neutral-500'>{repein.data.repein_ci}</span>
          <span>
            <span className='font-bold'>Nacionalidad: </span>
            <span className='text-neutral-500'>{repein.data.repein_nationality}</span>
          </span>
          <span>
            <span className='font-bold'>Fecha de nacimiento: </span>
            <span className='text-neutral-500'>{repein.data.repein_birthdate}</span>
          </span>
