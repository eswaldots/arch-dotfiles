    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(`w-full rounded-md bg-neutral-900 border-neutral-300 pl-10 pr-3 py-2 text-sm placeholder:text-neutral-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary`, className)}
          {...props}
          id={inputId}
          name={inputId}
        />
